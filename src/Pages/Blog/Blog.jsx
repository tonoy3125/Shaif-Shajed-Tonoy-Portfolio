        ...
        <div className="pb-28 pt-32 bg-[#070707]">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-7">
                    <div className="border border-[#353535] hover:border-[#c9f31d] bg-[#292828] lg:w-[630px] rounded-[15px] flex flex-col md:flex-row items-center gap-10 sm:pl-2 sm:pr-2 sm:pt-2 semi-sm:pl-3 semi-sm:pr-3 semi-sm:pt-3 md:pl-2 md:pt-2 md:pb-2 md:pr-10 card-container sm:mx-4 semi-sm:mx-5 md:mx-4 lg:mx-0">
                        <div className="">
                            <img className="md:max-w-60 md:h-56 rounded-[10px] object-cover" src="https://i.ibb.co/XypBGfh/blog-09-min-768x417.jpg" alt="" />
                        </div>
                        <div className="sm:mx-1 semi-sm:mx-2 md:mx-0">
                            ...
                            <h3 className="sm:text-xl semi-sm:text-[22px] font-lora font-bold text-white md:w-96">A Beginner’s Guide to Running Adventures</h3>
