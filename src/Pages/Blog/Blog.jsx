        ...
        <div className="pb-28 pt-32 bg-[#070707]">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-7">
                    <div className="border border-[#353535] bg-[#292828] w-[630px] rounded-[15px] flex items-center gap-10 pl-2 pt-2 pb-2 pr-10">
                        <div className="">
                        ...
                        <div className="">
                            ...
                            <h3 className="text-[22px] font-lora font-bold text-white w-96">A Beginner’s Guide to Running Adventures</h3>
