                            ...
                            <dialog id="my_modal_3" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> 2403836fa778a13cfdb650cf13deb5902fa55c20d5d64969328a4484c548d1a6</h4>
                            ...
                            <dialog id="my_modal_4" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> 68bd800f7d2076c50a6eadd2a641bf22900136df035c420f0d45ca873815ec52</h4>
                            ...
                            <dialog id="my_modal_5" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> 037e1d7dac9bfddbe6d795604ad6aba6ec80bb4dd0328d0934a250ffbc421c56</h4>
                            ...
                            <dialog id="my_modal_6" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> c58da85b02ce0b717ca3ccfd8eaaea73bf6e975af40bccd4ea371b7ce1b4a399</h4>
                            ...
                            <dialog id="my_modal_7" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> 5d9218996c83a53735c0207bca04368ebe4b5f7e3a9143e5746c9cbacc48d3cc</h4>
                            ...
                            <dialog id="my_modal_8" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> ddc08864fe88b5900986bdf304f3b386b1d8b4117da9f923ca23f85210a2535d</h4>
                            ...
                            <dialog id="my_modal_9" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> 5449a09dcb1a4ae3facf80ad9040480f11e4d54f89edeb299ee334aca8f651be</h4>
                            ...
                            <dialog id="my_modal_10" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> 238073717fb29c191c980a1809d5f28d631106b920bcf73a7967a50072f78440</h4>
                            ...
                            <dialog id="my_modal_11" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> d6fb578e2cf6932eb617ef1263d1d41ed6aa83f88b21b2b9b60a01a4706505a1</h4>
                            ...
                            <dialog id="my_modal_12" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> 226b58f034d3ba390927d4216b824c8a86f9592fceec6c897dd386dcbbe6631c</h4>
                            ...
                            <dialog id="my_modal_13" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> 7a4ca620fad5cbe4a4e748179ad4ca09ccacd46b933790d22ccc26e47f25e631</h4>
                            ...
                            <dialog id="my_modal_14" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> ac8495d2b15a9ad5d0434e5cd16e346688d6f2a96b28b60a1784c0b1aa07ccbe</h4>
                            ...
                            <dialog id="my_modal_15" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> 8fdad13b7df88f61ae4888c48e167c5a49eaa15b23500e093a57086815be9866</h4>
                            ...
                            <dialog id="my_modal_16" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> 6fe1eb7d445666972c6ba664279d1f414d0bb211e233c96db0e67931968cedef</h4>
                            ...
                            <dialog id="my_modal_17" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> 96087f3bcd8b920d7e2597f548836bf9d483e2a955a6bceecb84986d94f9281a</h4>
                            ...
                            <dialog id="my_modal_18" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> 749d50604b81a3f4742fce178b01448b3b28a92d81acb5900cea08f417588216</h4>
                            ...
                            <dialog id="my_modal_19" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> 2e0901f277b8dd9b46adb5d098aa8e3af90cfdf4a7b658d7ddf5cb691b25d5c9</h4>
                            ...
                            <dialog id="my_modal_20" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> efb508e0c878ae5319b2a03779813aed49777a61b4605152a712ac5dfb13f30b</h4>
                            ...
                            <dialog id="my_modal_21" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> a9ed3ca6637ff473ca6d2d513683a3dff6c96c1bbe088ef163968787cabd2e58</h4>
                            ...
                            <dialog id="my_modal_22" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> 07f06a9e890e38d5480001812aacb703a94d107db520c7d1d40e7b500ea8ac04</h4>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Skills :</span> OpenAI Products , Technical Solution Development</h4>
                                    </div>
                                    <hr className="mt-5 mb-2" />
                                </div>
                            </dialog>
                            ...
                            <dialog id="my_modal_23" className="modal">
                                ...
                                <div className="modal-box w-11/12 max-w-5xl modal-container">
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-base sm:text-lg semi-sm:text-xl md:text-2xl font-lora font-medium mt-2 '><span className='font-poppins font-bold'>Issuing organization :</span> Linkedin</h1>
                                        <h4 className='text-base semi-sm:text-lg md:text-xl font-lora font-medium mt-2 credential-id'><span className='font-poppins font-bold'>Credential ID :</span> 9c990a4512011f24eebef42f25ce5468d8f26d6707f718ea5f6ae56754b464cd</h4>
