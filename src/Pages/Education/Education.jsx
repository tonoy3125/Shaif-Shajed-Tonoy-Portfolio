    ...
    return (
        <div className="max-w-5xl mx-auto mb-20">
            <div className="grid grid-cols-1  gap-5 md:px-14 px-4 lg:px-0 font-lora">
                <div className=" rounded-lg text-center py-5 border-2 border-[#353535] shadow-2xl  bg-[#292828] hover:border-[#c9f31d]">
                ...
                <div className="border-2 border-[#353535] shadow-2xl  bg-[#292828] text-center rounded-lg py-5 hover:border-[#c9f31d]">
                ...
                <div className="border-2 border-[#353535] shadow-2xl  bg-[#292828] text-center rounded-lg py-5 px-1 hover:border-[#c9f31d]">
