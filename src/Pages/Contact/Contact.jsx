...
const Contact = () => {
    return (
        <div className="max-w-7xl mx-auto mt-24 mb-20">
            <div className="flex items-start flex-col lg:flex-row gap-20 md:ml-5 lg:ml-0">
                <div>
                    <h5 className="text-base font-poppins font-medium text-[#b1b1b1]">Get In Touch</h5>
                    <h1 className="font-poppins text-4xl lg:text-[45px] font-medium"><span className="text-[#fff]">Let’s Talk For your</span> <br className="lg:block md:hidden" /><span className="text-[#c9f31d]">Next Projects</span></h1>
                    <p className="text-base text-[#b1b1b1] font-poppins lg:w-[400px]">Sed ut perspiciatis unde omnin natus totam rem aperiam eaque inventore veritatis</p>
                </div>
                <div>
                    <div className="flex items-center  flex-col md:flex-row gap-5 lg:gap-10 mb-14" >
                        <div className="">
                            ...
                            <input className="pt-4 pb-4 pl-2 md:pl-8 md:py-5 md:w-[350px] lg:w-[380px] bg-[#292828]   text-base font-semibold font-lora text-white rounded-xl border  border-[#353535] focus:border-[#c9f31d] focus:outline-none" type="text" name="propertyname" placeholder="Enter Property Name Here" id="" />
                        </div>
                        <div className="">
                            ...
                            <input className="pt-4 pb-4 pl-2 md:pl-8 md:py-5 md:w-[350px] lg:w-[380px] bg-[#292828]   text-base font-semibold font-lora text-white rounded border  border-[#353535] focus:border-[#c9f31d] focus:outline-none" type="text" name="propertyname" placeholder="Enter Property Name Here" id="" />
                        </div>
                    </div>
