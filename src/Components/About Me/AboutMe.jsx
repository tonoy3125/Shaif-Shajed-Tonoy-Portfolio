        ...
        <div className="bg-[#070707] pt-28 pb-28">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col lg:flex-row gap-20">
                    <div className="semi-sm:mx-5 md:mx-10 lg:mx-0">
                        ...
                        <div className="flex flex-col md:flex-row md:items-center semi-sm:gap-5 md:gap-28 lg:gap-40 semi-sm:mt-5 md:mt-7">
                        ...
                        <div className="flex flex-col md:flex-row md:items-center semi-sm:gap-5 md:gap-[115px] lg:gap-[164px] semi-sm:mt-5 md:mt-7">
                            <div className="flex items-center gap-3">
                                <IoMdCheckmark className="text-2xl text-[#c9f31d]" />
                    ...
                    <div>
                        <img className=" max-w-[380px]  md:max-w-[450px] mx-auto h-[450px]" src="https://i.ibb.co/kHpnxzL/Gray-and-Orange-Simple-Linked-In-Profile-Picture.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
